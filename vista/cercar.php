...
<head>
    ...
    <title>VistaCerca_DVG</title>
</head>
<body>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <label for="titol">Introdueix titol de l'article:</label>
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($titol)) {
                $connexio = conexio();
                $articles = mostrarArticles($connexio, $titol);                                                             // Obtiene todos los artículos relacionados
                ...
                echo "Cal intoduir titol per cercar.";
            }
        }
    ?>                          
</body>
